...
public class GSelfOperatingHeuristicTextGenerator extends AbstractGenerator {
  ...
  public CharSequence generate(final Model model) {
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("currentState.setGlobalProps(new HashMap<String, Object>(globalProps));");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("this.globalProps = new HashMap<String, Object>(currentState.returnGlobalProps());");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("}");
    _builder.newLine();
